...
function JoinUS() {
  ...
  if (loggedInUser)
    return (
      <div
        className={`bg-primery-black-800 rounded-lg p-20 flex flex-col gap-3 md:gap-5 bg-[url('http://image.tmdb.org/t/p/original/rqbCbjB19amtOtFQbb3K2lgm2zv.jpg')] bg-contain bg-no-repeat bg-right before-overlay before:bg-opacity-50 relative *:z-20 lg:py-36`}
      >
